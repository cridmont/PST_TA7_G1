...
public class Categorias extends AppCompatActivity {
    ...
    // Se crean las categorías de libros haciendo uso de la base de datos inicial
            ...
            public void run() {
                ...
                if (fila.moveToFirst()) {
                    do {
                        ...
                        //Mostramos las imágenes representativas de cada categoria
                        ...
                        item.addView(btn);
                        //mapeamos la seleccion del usuario
