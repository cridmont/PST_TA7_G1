...
public class Main extends AppCompatActivity {
            ...
            public void run(){
                ...
                if(fila.moveToFirst()) {
                    do{
                        ...
                        String[] args = new String[]{"TITULO: ", "AUTOR: ", "AÑO DE UBLICACION: "};
                        for(int x=1; x<4; x++){
    ...
    public void verPerfil(View view){
        ...
        String msgl = datos.getString(Login.EXTRA_MESSAGE);
        startActivity(i);
    }
    ...
    public void verCategorias(View view){
        ...
        Bundle datos = this.getIntent().getExtras();
        String msgl = datos.getString(Login.EXTRA_MESSAGE);
        i.putExtra(Login.EXTRA_MESSAGE,msgl);
        startActivity(i);
    }

    public void inicio(View view){
        Toast.makeText(this, "Se encuentra en la seccion principal", Toast.LENGTH_SHORT).show();
    }
}